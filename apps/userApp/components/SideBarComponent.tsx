...
export const SideBarComponent = ({ href, title, icon }: { href: string; title: string; icon: React.ReactNode }) => {
    ...
    return (
        <div className={`flex items-center min-w-100% max-w-[250] cursor-pointer p-2 pl-6 transition-all duration-300 ${selected ? "border-l-4 bg-blue-500 bg-blue-100 text-white" : "text-black"}`} 
